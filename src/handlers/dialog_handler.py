...
class DialogHandlerMixin:
    ...
    def show_shortcuts(self):
        ...
        QMessageBox.information(
            ...
            "<tr><td><b>K</b></td><td>Pause/Resume Video</td></tr>"
            "<tr><td><b>Ctrl+Left</b></td><td>Seek Backward 5s</td></tr>"
            "<tr><td><b>Ctrl+Right</b></td><td>Seek Forward 5s</td></tr>"
            "<tr><td><b>Ctrl++</b></td><td>Zoom In</td></tr>"
            "<tr><td><b>Ctrl+-</b></td><td>Zoom Out</td></tr>"
            "<tr><td><b>Ctrl+0</b></td><td>Reset Zoom</td></tr>"
            "<tr><td><b>Drag Left Mouse</b></td><td>Pan View when Zoomed In</td></tr>"
