...
# Base directory - go up one level from src/ to traffic-violation-detector/
...
MODEL_TYPES = {
    ...
    "RT-DETR": {
        ...
        "classes": [0, 1, 2, 5],  # Different class mapping
        "default_imgsz": 640,
        "default_conf": 0.5
    }
}
...
def get_available_weights(model_type):
...
def get_weight_path(model_type, weight_name):
