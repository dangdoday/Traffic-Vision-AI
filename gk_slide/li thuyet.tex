...
\begin{frame}{PaddleOCR - Giới thiệu}
    ...
    \begin{itemize}
        ...
        \item Độ chính xác cao, tốc độ nhanh (real-time)
...
\begin{frame}{TPS - Thin-Plate Spline}
    ...
    \vspace{0.3em}
    \textbf{Kết quả:} Văn bản cong $\rightarrow$ Văn bản thẳng
\end{frame}
...
\begin{frame}[allowframebreaks]{Kiến trúc SVTR - Scene Text Recognition}
    ...
    \vspace{0.3em}
    \textbf{Ưu điểm:} Tính toán song song, ngữ cảnh toàn cục, độ chính xác cao hơn 1-2\%
\end{frame}
...
\begin{frame}{So sánh SVTR và CRNN}
    ...
    Tốc độ & Chậm hơn & Nhanh hơn \\ \hline
    \end{tabular}
    \end{table}
...
\begin{frame}{Validation \& Character Correction}
    ...
    \begin{column}{0.42\textwidth}
        ...
        \tiny Kết quả validation biển số
    \end{column}
    \end{columns}
\end{frame}