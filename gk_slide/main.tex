...
% NOTE: Avoid Helvetica/Times with T5 to prevent missing vntex fonts on some MiKTeX setups.
...
% --- KẾT THÚC TUỲ CHỈNH FOOTER ---

% Defining title, author, and date
\title{BÁO CÁO GIỮA KỲ \\ HỆ THỐNG GIÁM SÁT GIAO THÔNG THÔNG MINH \\ VÀ NHẬN DIỆN BIỂN SỐ XE VIỆT NAM}
