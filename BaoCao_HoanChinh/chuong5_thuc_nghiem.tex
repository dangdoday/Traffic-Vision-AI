...
\multirow{4}{*}{Phát hiện phương tiện} & mAP@50 & 86.1\% \\ \cline{2-3}
 & Precision & 87.2\% \\ \cline{2-3}
 & Recall & 78.1\% \\ \cline{2-3}
 & FPS (inference) & 25-30 FPS \\ \hline
\multirow{4}{*}{Phát hiện biển số} & mAP@50 & 99.5\% \\ \cline{2-3}
 & Precision & 99.97\% \\ \cline{2-3}
 & Recall & 99.86\% \\ \cline{2-3}
 & FPS (with OCR) & 5-10 FPS \\ \hline
\multirow{2}{*}{Full pipeline} & Tốc độ xử lý & 5-10 FPS \\ \cline{2-3}
 & Tỷ lệ OCR thành công & 100\% (test set) \\ \hline
\end{tabular}
\end{table}

Với kết quả \textbf{mAP@50 đạt 86.1\%} cho phát hiện phương tiện và \textbf{99.5\%} cho phát hiện biển số, hệ thống đáp ứng tốt yêu cầu giám sát giao thông và nhận diện biển số xe Việt Nam. Tốc độ xử lý 25-30 FPS (không OCR) hoặc 5-10 FPS (full pipeline) phù hợp cho các ứng dụng realtime trên phần cứng phổ thông.
